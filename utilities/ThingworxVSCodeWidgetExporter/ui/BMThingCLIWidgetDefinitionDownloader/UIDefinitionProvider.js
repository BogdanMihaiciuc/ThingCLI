window.queueMicrotask(async function () {
    ...
    function downloadWidgets() {// These widgets are already built-in and should not be downloaded
        ...
        downloader.href = 'data:attachment/text,' + encodeURIComponent(content);
